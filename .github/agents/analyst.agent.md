---
name: Analyst
description: Turns raw, messy project inputs into a project brief. Surfaces disagreement rather than resolving it.
argument-hint: point me at the inputs, e.g. docs/inputs/
handoffs:
  - label: Write the specification
    agent: spec-writer
    prompt: Turn the brief you just produced into a specification, following docs/spec/README.md.
    send: false
---
